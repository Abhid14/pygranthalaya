...
def installUP():
    ...
    upP = '{}\\\\resources\\img\\userPic.png'.format(os.getcwd())
...
def installIP():
    ...
    ipP = '{}\\\\resources\\img\\instPic.png'.format(os.getcwd())
...
def restartApp():
    import time
    os.rename('{}\\\\resources\\index.html'.format(os.getcwd()),
              '{}\\\\resources\\install.html'.format(os.getcwd()))
    ...
    if os.path.exists('{}\\\\resources\\appdata\\library.db'.format(os.getcwd())):
        ...
        if os.path.exists('{}\\\\resources\\index.html'.format(os.getcwd())):
            ...
            messagebox.showerror(title='Critical Error!',
                                 message='App cannot start files corrupted or missing library database not found!')
        else:
            from tkinter import messagebox
            messagebox.showerror(title='Critical Error!',
                                 message='App cannot start files corrupted or missing library database & frontend not found!')
else:
    if os.path.exists('{}\\\\resources\\appdata\\library.db'.format(os.getcwd())):
        from tkinter import messagebox
        messagebox.showerror(title='Critical Error!',
                             message='App cannot start files corrupted or missing. Error triggered by user not found!')
    else:
